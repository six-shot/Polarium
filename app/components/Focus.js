...
import focus2 from "../../public/focus1.webp";
import focus3 from "../../public/focus1.webp";
    ...
    <div className="max-w-[1440px] mx-auto px-6 xl:px-10 2xl:px-0">
      ...
      <div className="flex xl:flex-row flex-col gap-7">
        <div className="flex flex-col items-center">
          ...
          <p className="silka text-[18px] text-center">
            Polarium commits to set near- and long-term company-wide emission
            reductions in line with science-based net-zero with the SBTi.
          </p>
